...
namespace F88.Digital.Infrastructure.Identity.Seeds
{
    public static class DefaultSuperAdminUser
    {
        ...
        private async static Task SeedClaimsForSuperAdmin(this RoleManager<IdentityRole> roleManager)
        {
            ...
            await roleManager.AddPermissionClaim(adminRole, "UserProfiles");
            await roleManager.AddPermissionClaim(adminRole, "UserOTP");
        }
